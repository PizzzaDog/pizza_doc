...
Instructions for Codex / AI agents working in this repo.
...
- `.Codex/skills/` — role-specific playbooks for different agent tasks (see below).
...
See [`.Codex/skills/README.md`](.Codex/skills/README.md) for the full
