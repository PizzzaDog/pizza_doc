...
| Language | Skill |
|---|---|
| Java / Kotlin | `.claude/skills/pd-extract-java/SKILL.md` |
| TypeScript / JavaScript | `.claude/skills/pd-extract-typescript/SKILL.md` |
| Python | `.claude/skills/pd-extract-python/SKILL.md` |
| Go | `.claude/skills/pd-extract-go/SKILL.md` |
