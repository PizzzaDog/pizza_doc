...
Pizza Doc сейчас на версии `0.5.1` <!-- pd:version --> — мы активно обкатываем формат. Если упёрся в ограничение схемы, нашёл false positive валидатора, или хочешь новую категорию — кидай конкретный кейс (минимальный YAML + что ожидал) автору, он подкрутит и пришлёт обновление.
